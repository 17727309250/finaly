...
CREATE SEQUENCE SEQ_VOUCHER_DETAIL INCREMENT BY 1 START WITH 300 NOMAXVALUE NOCYCLE CACHE 10;
CREATE SEQUENCE SEQ_CHECK_RESULT INCREMENT BY 1 START WITH 300 NOMAXVALUE NOCYCLE CACHE 10;
CREATE SEQUENCE SEQ_LEAVE INCREMENT BY 1 START WITH 300 NOMAXVALUE NOCYCLE CACHE 10;
CREATE SEQUENCE hibernate_sequence INCREMENT BY 1 START WITH 300 NOMAXVALUE NOCYCLE CACHE 10;
...
insert into SYS_EMPLOYEE (SN, POSITION_ID, DEPARTMENT_ID, NAME, PASSWORD, STATUS)
values ('001', 1, 2, '张平', '202cb962ac59075b964b07152d234b70', '在职');
insert into SYS_EMPLOYEE (SN, POSITION_ID, DEPARTMENT_ID, NAME, PASSWORD, STATUS)
values ('002', 2, 2, '叶宁', '202cb962ac59075b964b07152d234b70', '在职');
insert into SYS_EMPLOYEE (SN, POSITION_ID, DEPARTMENT_ID, NAME, PASSWORD, STATUS)
values ('003', 3, 3, '李伟', '202cb962ac59075b964b07152d234b70', '在职');
insert into SYS_EMPLOYEE (SN, POSITION_ID, DEPARTMENT_ID, NAME, PASSWORD, STATUS)
values ('004', 4, 4, '王小明', '202cb962ac59075b964b07152d234b70', '离职');
insert into SYS_EMPLOYEE (SN, POSITION_ID, DEPARTMENT_ID, NAME, PASSWORD, STATUS)
values ('005', 1, 3, '林风', '202cb962ac59075b964b07152d234b70', '在职');
insert into SYS_EMPLOYEE (SN, POSITION_ID, DEPARTMENT_ID, NAME, PASSWORD, STATUS)
values ('006', 1, 3, '张大明', '202cb962ac59075b964b07152d234b70', '在职');
insert into SYS_EMPLOYEE (SN, POSITION_ID, DEPARTMENT_ID, NAME, PASSWORD, STATUS)
values ('011', 1, 1, '李大伟1', '202cb962ac59075b964b07152d234b70', '在职');
insert into SYS_EMPLOYEE (SN, POSITION_ID, DEPARTMENT_ID, NAME, PASSWORD, STATUS)
values ('007', 1, 1, '李大伟', '202cb962ac59075b964b07152d234b70', '在职');
insert into SYS_EMPLOYEE (SN, POSITION_ID, DEPARTMENT_ID, NAME, PASSWORD, STATUS)
values ('008', 3, 5, '张总', '202cb962ac59075b964b07152d234b70', '在职');
insert into SYS_EMPLOYEE (SN, POSITION_ID, DEPARTMENT_ID, NAME, PASSWORD, STATUS)
values ('009', 4, 4, '李峰', '202cb962ac59075b964b07152d234b70', '在职');
insert into SYS_EMPLOYEE (SN, POSITION_ID, DEPARTMENT_ID, NAME, PASSWORD, STATUS)
values ('018', 1, 1, '李大伟', '202cb962ac59075b964b07152d234b70', '在职');
commit;
...
insert into BIZ_CLAIM_VOUCHER (ID, NEXT_DEAL_SN, CREATE_SN, CREATE_TIME, EVENT, TOTAL_ACCOUNT, STATUS, MODIFY_TIME)
values (200, null, '001', to_date('23-10-2013 13:47:44', 'dd-mm-yyyy hh24:mi:ss'), '202cb962ac59075b964b07152d234b70', 34, '新创建', to_date('23-10-2013 13:47:56', 'dd-mm-yyyy hh24:mi:ss'));
insert into BIZ_CLAIM_VOUCHER (ID, NEXT_DEAL_SN, CREATE_SN, CREATE_TIME, EVENT, TOTAL_ACCOUNT, STATUS, MODIFY_TIME)
...
insert into BIZ_CLAIM_VOUCHER (ID, NEXT_DEAL_SN, CREATE_SN, CREATE_TIME, EVENT, TOTAL_ACCOUNT, STATUS, MODIFY_TIME)
values (198, null, '001', to_date('23-10-2013 13:45:32', 'dd-mm-yyyy hh24:mi:ss'), '202cb962ac59075b964b07152d234b70', 44, '新创建', to_date('23-10-2013 13:47:24', 'dd-mm-yyyy hh24:mi:ss'));
insert into BIZ_CLAIM_VOUCHER (ID, NEXT_DEAL_SN, CREATE_SN, CREATE_TIME, EVENT, TOTAL_ACCOUNT, STATUS, MODIFY_TIME)
values (175, null, '001', to_date('22-10-2013 16:13:03', 'dd-mm-yyyy hh24:mi:ss'), '202cb962ac59075b964b07152d234b70', 12, '新创建', null);
insert into BIZ_CLAIM_VOUCHER (ID, NEXT_DEAL_SN, CREATE_SN, CREATE_TIME, EVENT, TOTAL_ACCOUNT, STATUS, MODIFY_TIME)
